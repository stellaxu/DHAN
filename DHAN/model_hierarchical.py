...
class Model(object):
  ...
  def train(self, sess, uij, l):
    loss, _ ,ic,item_b,cate_list ,i,hist_i,hc,i_emb,h_emb,hist_i_con,hist_c_con,check_hist_i = sess.run([self.loss, self.train_op,self.ic,self.item_b,self.cate_list,self.i,self.hist_i,self.hc,self.i_emb,self.h_emb,self.hist_i_con,self.hist_c_con,self.check_hist_i], feed_dict={
        self.u: uij[0],
        self.i: uij[1],
        self.y: uij[2],
        self.hist_i: uij[3],
